...
public class JogoDeCobra extends JFrame implements KeyListener {
    ...
    public void salvarProgresso(String score) {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter("progresso.txt"));
            writer.write(score);
            writer.newLine();
    ...
    public void desenharEfeito(Graphics g) {
        try {
            switch (efeito) {
                case 1: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/+200.png")); break;
                case 2: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Score x2.png")); break;
                case 3: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Velocidade--.png")); break;
                case 4: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Portal.png")); break;
                case 5: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Cobra_bomba.png")); break;
                case 6: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Fantasma.png")); break;
                case 7: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/-200.png")); break;
                case 8: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Score -2.png")); break;
                case 9: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Velocidade++.png")); break;
                case 10: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Minas.png")); break;
                case 11: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Noturno.png")); break; 
                case 12: image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Veneno.png")); break;
            }
    ...
    public void removerEfeito(Graphics g) {
        ...
        /*try {
        image = ImageIO.read(new File("/home/timana/Documents/3 Semestre/FP/Trabalho Semestral/Efeitos/Blank.png"));
             ...
             for (j = 1; j <= width; j++) {
                  if (obstaculo[i][j] == true) {
                      ...
                      if ((obstaculo[i][j+j2] == false && j+j2 != 0 && j+j2 != width+1)) {
                          ...
                          livre[i][j] = true;
                          livre[i][j+j2] = false;
                          if (removerElemento(g,i,j2) == true)
                              obstaculado = true;
                          //if (invalido == true) {
                          g.setColor(fundo_cor);
                          g.fillRect(quadro_x+((j-1)*11),quadro_y+((i-1)*11),11,11);
        ...
        do {
            ...
            while(vencedor == 0 && (perdeu == false && nivel == 0) || (perdeu == false && (sco < meta || (nivel == 7 && boss_derrotado == false)))) {
                ...
                if (nivel == 0) {       
                    ...
                    if (boss_derrotado == false && sco == 6000/*0*/ && (reagendar_boss_movimento == true || reagendar_boss_ataque == true)) {//movimento do boss
                                    ...
                                    if (interromper_boss_ataque == false && boss_ataque_timer >= boss_ataque_timer_alvo) {
                                        ...
                                        if (boss_ataque_refletor == false) {
                                            if (boss_ataque_count % 30 == 0 && boss_ataque_count != 0) {
                                              ...
                                              if ((boss_ataque_count % 2 == 0 && boss_ataque_count != 0) || cobra_presa == true) {
                                                  if (boss_loop < 4) {
                                                          ...
                                                          for (j = 1; j <= width; j++) {
                                                               ...
                                                               for (i = linha1; i <= linha2; i++) {
                                                                    if ( i == -1 || i == 2 || boss_ataque_timer >= 400) {//torna false os lugares onde o laser ja nao esta
                                                                      ...
                                                                      livre[y+i][x] = false;
                                                                      if (removerElemento(g,(y+1),x) == true)
                                                                          lasado = true;
                                                                      g.setColor(fundo_cor);
                ...
                for (id = 0; id < num_jogadores; id++) { 
                    ...
                    if (obstaculo[y][x] == true && efeito != 5)
                        obstaculado = true;
